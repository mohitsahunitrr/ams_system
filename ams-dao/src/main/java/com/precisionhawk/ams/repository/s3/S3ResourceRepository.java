package com.precisionhawk.ams.repository.s3;
...
public class S3ResourceRepository implements ResourceRepository {
    ...
    private static final String META_ASSET_ID = "precisionhawk.asset.id";
    private static final String META_NAME = "precisionhawk.resource.name";
    private static final String META_SOURCE_ID = "precisionhawk.source.id";
    private static final String META_SITE_ID = "precisionhawk.site.id";
    private static final String META_ZOOMIFY_FOR_ID = "precisionhawk.zoomifyFor.id";
    ...
    public void storeResource(ResourceMetadata metaData, String key, String name, String contentType, InputStream resourceStream, Long length) throws RepositoryException {
        ...
        ometa.addUserMetadata(META_ASSET_ID, metaData.getAssetId());
        ometa.addUserMetadata(META_SITE_ID, metaData.getSiteId());
        ...
        if (object == null) {
            ...
            try {
                ...
                if (object.getObjectMetadata().getContentLength() > MAX_IN_MEMORY_RESOURCE_SIZE) {
                    tmp = File.createTempFile("ams_", null);
